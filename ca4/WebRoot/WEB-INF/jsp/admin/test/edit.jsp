	...
	<form id="form1" name="form1" action="" method="post">
		...
		<center>
			<table class="mobile" style="width: 95%;">
				...
				<tr height="25">
					<td class="outDetail" style="width: 30%">用户： <label
				...
				<tr height="25">
					<td class="outDetail" style="width: 30%">姓名： <label
						style="font-weight: bold; color: red"> </label></td>
					<td class="outDetail2"><input type="text" id="testName"
						value="${map.testName }" name="testName" /></td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">内容： <label
						style="font-weight: bold; color: red"> </label></td>
					<td class="outDetail2"><textarea rows="5" id="testContent"
							cols="50" name="testContent">${map.testContent }</textarea></td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">性别： <label
						style="font-weight: bold; color: red"> </label></td>
					<td class="outDetail2"><input type="text" id="testSex"
						value="${map.testSex }" name="testSex" /></td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">日期： <label
						style="font-weight: bold; color: red"> </label></td>
					<td class="outDetail2"><input name="testDay" id="testDay"
						value="${map.testDay }" type="text" onClick="WdatePicker()" /></td>
				</tr>
				<tr height="25">
					...
					<td class="outDetail2"><input id="f_fileImg0" name="cmfile"
						...
						<input class="text" type="hidden" name="testPic" id="bbbbbImg0"
						value="${map.testPic }"> <c:if
							test="${map.testPic!=null }">
							<img style='width:100px;' src="${ctx }/${map.testPic}"
								id="aaaaaImg0" />
						</c:if></td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">时间： <label
						style="font-weight: bold; color: red"> </label></td>
					<td class="outDetail2"></td>
				</tr>
				<c:if test="${1==1 }"></c:if>
